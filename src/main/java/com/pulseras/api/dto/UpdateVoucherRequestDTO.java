...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request DTO for updating an existing voucher")
public class UpdateVoucherRequestDTO {
    ...
    @Schema(description = "Whether the voucher is active", example = "true")
    private Boolean isActive = true;
    
    @Size(max = 200, message = "Ban reason must not exceed 200 characters")
    @Schema(description = "Reason for banning/deactivating the voucher", example = "Expired and deactivated")
